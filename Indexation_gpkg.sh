...
for file in QC_CUBE_Richesse_spe_N01_wkt_raw_obs_SIMPL_latlon QC_CUBE_Richesse_spe_N02_wkt_raw_obs_SIMPL_latlon QC_CUBE_Richesse_spe_N03_wkt_raw_obs_SIMPL_latlon QC_CUBE_Richesse_spe_N04_wkt_raw_obs_SIMPL_latlon
do
    echo ${file}
